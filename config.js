...
module.exports = {
    // ===== BOT CORE SETTINGS =====
    SESSION_ID: process.env.SESSION_ID || "SUBZERO-MD~1yhGQZZBRERsCWS5I2LJ",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "256755058787",  // Owner's WhatsApp number
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "Mr Frank",           // Owner's name
    DEV: process.env.DEV || "256755058787",                     // Developer's contact number
    ...
    STICKER_NAME: process.env.STICKER_NAME || "nik",     // Sticker pack name
